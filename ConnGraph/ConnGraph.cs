...
namespace Connectivity
{
    ...
    public class ConnGraph : IConnGraph
    {
        ...
        public readonly ConnGraphComponentStorageType componentStorageType;
        ...
        public ConnGraph(IAugmentation augmentation = null, ConnGraphComponentStorageType storageType = ConnGraphComponentStorageType.Dictionary)
        {
            ...
            switch (storageType)
            {
                case ConnGraphComponentStorageType.Disabled:
                    _components = new ConnGraphComponentStorageDisabled();
                    break;
